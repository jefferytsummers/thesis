...
\hskip+1.7cm\begin{tabular}{| c c c c |}
	...
	\end{tabular}
	\newline
		\includegraphics[width=4in]{acetone_mode.png}
		\caption{Index shift measurements for acetone.}
\end{figure}
\vspace{-1.2cm}
\begin{figure}
\hskip+1.7cm\begin{tabular}{| c c c c |}
	...
	\end{tabular}
	\newline
		\includegraphics[width=4in]{isopropal_mode.png}
		\caption{Index shift measurements for 70\% isopropyl alcohol.}
\end{figure}